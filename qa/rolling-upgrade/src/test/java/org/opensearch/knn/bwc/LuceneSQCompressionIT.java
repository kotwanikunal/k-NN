    ...
    public void testRollingUpgrade_luceneSQ() throws Exception {
        ...
        switch (getClusterType()) {
            ...
            case MIXED:
                ...
                Map<String, Object> mixedFieldProps = (Map<String, Object>) ((Map<String, Object>) mixedMappings.get(PROPERTIES)).get(
                    TEST_FIELD
                );
            ...
            case UPGRADED:
                ...
                Map<String, Object> upgradedFieldProps = (Map<String, Object>) ((Map<String, Object>) upgradedMappings.get(PROPERTIES)).get(
                    TEST_FIELD
                );
