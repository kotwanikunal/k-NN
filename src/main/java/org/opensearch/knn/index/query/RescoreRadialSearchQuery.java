 ...
 *
 * <p><b>Currently unreachable:</b> radial search on quantized indices is blocked unconditionally in
 * {@link KNNQueryBuilder} via {@link org.opensearch.knn.index.engine.ResolvedIndexSpec#supportsRadialSearch},
 * so no supported request path constructs this query today. The implementation is retained, rather
 * than deleted, for when radial search on quantized indices is re-enabled behind a more robust
 * scoring approach — see <a href="https://github.com/opensearch-project/k-NN/issues/3452">#3452</a>.</p>
>>>>>>> Stashed changes
 *
 * <h2>Problem</h2>
